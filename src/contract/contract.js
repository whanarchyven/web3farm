...
class ContractConnector {
    ...
    erc1155ABI = [{"inputs": [], "stateMutability": "nonpayable", "type": "constructor"}, {
        "anonymous": false,
    ...
    constructor() {
        this.rewardToken = new web3.eth.Contract(this.rewardTokenABI, this.rewardTokenAddress);
        this.stakedToken = new web3.eth.Contract(this.stakedTokenABI, this.stakedTokenAddress);
        this.erc1155 = new web3.eth.Contract(this.erc1155ABI, this.erc1155Address);
        this.staking = new web3.eth.Contract(this.stakingABI, this.stakingAddress);
    }
